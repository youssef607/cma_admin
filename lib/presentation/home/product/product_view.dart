...
class _ProductViewState extends State<ProductView> {
          ...
          CustomDataTable(
              ...
              rows: products
                  .map((product) => DataRow(cells: [
                        ...
                        DataCell(Switch(
                            value: product.active, onChanged: (value) {
                              _viewModel.activeToggle(product, products);
                            })),
                        DataCell(Row(
                          children: [
                            ActionButton(
  ...
  Widget _getStatiqueGrid(List<Product> products) {
    ...
    return ResponsiveGrid(
      ...
      DataStatistiqueItem(
          label: AppStrings.total, count: products.length.toString(), color: ColorManager.orange, icon: IconManger.total,),
    ]);
  }
}
